...
public class EquipmentListBean {
	private List<EquipmentBean> SheBeiMuLu = new ArrayList<EquipmentBean>();

	public List<EquipmentBean> getSheBeiMuLu() {
		return SheBeiMuLu;
	}

	public void setData(List<EquipmentBean> SheBeiMuLu) {
		this.SheBeiMuLu = SheBeiMuLu;
	}
